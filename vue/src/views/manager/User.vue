  ...
  <div>
    ...
    <div class="card" style="margin-bottom: 5px">
      ...
      <el-table :data="data.tableData" stripe style="width: 100%">
        ...
        <el-table-column label="账户金额" prop="account" min-width="120"></el-table-column>
    ...
    <el-dialog title="信息" width="30%" v-model="data.formVisible" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="data.form" label-width="80px" style="padding-right: 30px">
        ...
        <el-form-item label="账户金额" prop="account">
          <el-input-number v-model="data.form.account" :min="0" :max="99999999.99" :precision="2" style="width: 100%" />
        </el-form-item>
      </el-form>
      <template #footer>
